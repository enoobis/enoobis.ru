...
<template>
  <div class="layout">
    <header class="nav">
      ...
      <RouterLink v-if="auth.token" to="/courses" class="nav-link desktop-only"><span>курсы</span></RouterLink>
      <RouterLink v-if="auth.token" to="/library" class="nav-link desktop-only"><span>библиотека</span></RouterLink>
